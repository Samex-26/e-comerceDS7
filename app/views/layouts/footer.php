...
<?php require_once BASE_PATH . '/views/layouts/cookie_banner.php'; ?>
<footer class="site-footer mt-5 py-4">
    <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center gap-3" style="max-width: 1320px;">
        <div class="text-center text-md-start">
            <p class="fw-bold mb-1" style="color: #1e293b; font-size: 1.25rem;">e-comerceDS7</p>
            <p class="small mb-0" style="color: #64748b;">© 2026 e-comerceDS7. Universidad Tecnológica de Panamá.</p>
            <p class="small mb-0" style="color: #64748b;">Westland Mall, Local 26, Autopista Arraiján-La Chorrera, Arraiján, Panamá</p>
        </div>
